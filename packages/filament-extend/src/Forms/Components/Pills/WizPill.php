...
namespace Wiz\FilamentExtend\Forms\Components\Pills;
use Closure;
use Filament\Forms\Components\Component;
use Filament\Forms\Components\Contracts\CanConcealComponents;
use Illuminate\Support\Str;

class WizPill extends Component implements CanConcealComponents
{
    protected string | Closure | null $icon = null;

    protected string | Closure | null $badge = null;

    protected string $view = 'wiz-filament-extend::forms.components.pills.pill';
