...
class EncryptPhoneSingle implements CastsAttributes
{
     ...
     */
    public function get(\Illuminate\Database\Eloquent\Model $model, $key, $value, $attributes): bool|array|string
    {
        return WizSecurity::decryptPhone($value);
    }
    ...
    public function set(\Illuminate\Database\Eloquent\Model $model, string $key, $value, array $attributes): ?string
    {
        if(is_string($value) && $value){
            return WizSecurity::encryptPhone($value);
        }
        return null;
