...
return [
    ...
    'profiles' => [
        'default' => [
            ...
            'toolbar' => 'undo redo removeformat  | fontsizeinput  styles | bold italic underline  | alignjustify alignleft aligncenter alignright | numlist bullist outdent indent | forecolor backcolor | blockquote table toc hr | image link media codesample emoticons | wordcount  | rtl ltr',
        ...
        'full' => [
            ...
            'toolbar' => 'undo redo removeformat |  fontsizeinput font_size_formats  | image link  media  | bold italic underline | alignjustify alignright aligncenter alignleft | numlist bullist outdent indent accordion | forecolor backcolor | blockquote table toc hr | anchor codesample emoticons  | visualblocks print preview wordcount fullscreen help | rtl ltr',
            'upload_directory' => null,
        ],
    ],
